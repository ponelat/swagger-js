...
var Operation = module.exports = function (parent, scheme, operationId, httpMethod, path, args, definitions, models, authorizations) {
  var errors = [];
  ...
  this.authorizations = parent.authorizations.concat(authorizations);
...
Operation.prototype.execute = function (arg1, arg2, arg3, arg4, parent) {
  ...
  Auth.applyAuths(this.authorizations, obj, this.operation.security);
...
Operation.prototype.asCurl = function (args) {
  ...
  Auth.applyAuths(this.authorizations, obj, this.security)
